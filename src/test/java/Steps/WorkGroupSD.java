...
public class WorkGroupSD extends BaseUtil {
    ...
    public void userShouldSelectTheSeniorityRule() {
    ...
    public void userShouldSelectTheShiftRuleSet() {
    ...
    public void userShouldSelectThePTORuleSet() {
    ...
    public void userShouldSelectTheUTORuleSet() {
    ...
    public void userShouldSelectTheVTOSlotRuleSet() {
